            ...
            <div class="header-actions">
                ...
                <div class="login_dropdown">
                    ...
                    <div class="content">
                        ...
                        <a href="./Admin/adminlogin.php">Login Admin</a>
                    </div>
                </div>
                    ...
                    <ul class="property-listings-list">
                        ...
                        <li>
                            <div class="property-listings-card">
                                ...
                                <figure class="card-banner">
                                    <img src="./assets/images/banner_7.jpg" alt="BMW 3 Series 2019" loading="lazy"
                                        width="440" height="300" class="w-100">
                                </figure>
                        ...
                        <li>
                            <div class="property-listings-card">
                                ...
                                <figure class="card-banner">
                                    <img src="./assets/images/banner_8.jpg" alt="BMW 3 Series 2019" loading="lazy"
                                        width="440" height="300" class="w-100">
                                </figure>
                        ...
                        <li>
                            <div class="property-listings-card">
                                ...
                                <figure class="card-banner">
                                    <img src="./assets/images/banner_9.jpg" alt="BMW 3 Series 2019" loading="lazy"
                                        width="440" height="300" class="w-100">
                                </figure>
